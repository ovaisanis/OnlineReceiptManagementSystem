    	...
    	#region Methods
    		...
    		public static Helpers.ActionResult Add(Helpers.ApiContext apiContext, Entities.WarrantyCard warrantyCard,out long id)
        	{
        		...
        		try
        		{
        			...
        			context.AddObject("Images", warrantyCard);
        				    
        			context.SaveChanges(); // Save Changes	
    			
                    id = warrantyCard.Id;
    
        			DetachObjects(apiContext, new System.Collections.Generic.List<Entities.WarrantyCard> {warrantyCard }); // Clean ObjectState cache
