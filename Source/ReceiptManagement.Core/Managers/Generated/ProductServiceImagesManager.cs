...
namespace ReceiptManagement.Core.Managers
{
    ...
    /// </summary>
    public sealed partial class ProductServiceImagesManager : EntityManager
    {	
    	#region Methods
            ...
            static partial void OnAdding(Helpers.ApiContext apiContext, Entities.Product_Service_Images product_Service_Images);
            ...
            static partial void OnDeleting(Helpers.ApiContext apiContext, Entities.Product_Service_Images product_Service_Images);
    
            //	This partial method gives us a way to access an object after it has been deleted from the system.
            static partial void OnDeleted(Helpers.ApiContext apiContext, Entities.Product_Service_Images product_Service_Images);
    
            //	This partial method gives us a way to update an object before it is imported into the system.
            static partial void OnImporting(Helpers.ApiContext apiContext, Entities.Product_Service_Images product_Service_Images);
    
            //	This partial method gives us a way to access an object after it has been imported into the system.
            static partial void OnImported(Helpers.ApiContext apiContext, Entities.Product_Service_Images product_Service_Images);
    
            //	This partial method gives us a way to bulk update an object before it is bulk updated in the system.
            static partial void OnBulkUpdating(Helpers.ApiContext apiContext, System.Collections.Generic.IEnumerable<Entities.Product_Service_Images> product_Service_ImagesList);
    
            //	This partial method gives us a way to access an object after it has been bulk updated in the system.
            static partial void OnBulkUpdated(Helpers.ApiContext apiContext, System.Collections.Generic.IEnumerable<Entities.Product_Service_Images> product_Service_ImagesList);
    
            //	This partial method gives us a way to access an object during it is bulk updated in the system.
            static partial void OnPartialUpdate(Helpers.ApiContext apiContext, Entities.Product_Service_Images product_Service_Images);
    		
    		//	This partial method gives us a way to access an object before it is validated in the system.
            static partial void OnValidating(Helpers.ApiContext apiContext, Entities.Product_Service_Images product_Service_Images, ref Helpers.ActionResult result);
            ...
            static partial void OnPurging(Helpers.ApiContext apiContext, Entities.Product_Service_Images product_Service_Images);
    		...
    		public static Helpers.ActionResult Add(Helpers.ApiContext apiContext, Entities.Product_Service_Images product_Service_Images,out long id)
        	{
        		...
        		try
        		{
        			...
        			context.AddObject("Images", product_Service_Images);
        				    
        			context.SaveChanges(); // Save Changes	
    			
                    id = product_Service_Images.Id;
    
        			DetachObjects(apiContext, new System.Collections.Generic.List<Entities.Product_Service_Images> {product_Service_Images }); // Clean ObjectState cache
    		...
    		/// <returns></returns>
    		public static Helpers.ActionResult Add(Helpers.ApiContext apiContext, System.Collections.Generic.IEnumerable<Entities.Product_Service_Images> product_Service_ImagesList)
    		{
    			return Add(apiContext, product_Service_ImagesList, false);
    		}
    		...
    		/// <returns></returns>
    		public static Helpers.ActionResult Add(Helpers.ApiContext apiContext, System.Collections.Generic.IEnumerable<Entities.Product_Service_Images> product_Service_ImagesList, System.Boolean clientWins)
    		{
    			// API doesn't allow null parameters. This method requires at least 1 item in the collection.
                if (apiContext == null)
                    throw new System.ArgumentNullException("apiContext");
    			...
    			try
    			{
    				...
    				foreach (Entities.Product_Service_Images product_Service_Images in product_Service_ImagesList)
    				{
    					if (!clientWins)
    					{
    				    	...
    				    	SetSystemProperties(apiContext, product_Service_Images, false);
    					}
    				...
    				foreach (Entities.Product_Service_Images product_Service_Images in product_Service_ImagesList)
    					OnAdded(apiContext, product_Service_Images);
    			}
    			catch (System.Exception ex)
    			{		
    				object forDebugging = ex;
    		...
    		/// <param name="product_Service_ImagesList"></param>
    		/// <returns></returns>
            public static Helpers.ActionResult Delete(Helpers.ApiContext apiContext, System.Collections.Generic.IEnumerable<Entities.Product_Service_Images> product_Service_ImagesList)
            {
    			// API doesn't allow null parameters. This method requires at least 1 item in the collection.
                if (apiContext == null)
                    throw new System.ArgumentNullException("apiContext");
                ...
                {				
                    ...
                    foreach (Entities.Product_Service_Images product_Service_Images in product_Service_ImagesList)
                    {
    					OnDeleting(apiContext, product_Service_Images);
    					...
    					// SET SoftDeleted
    					SetDeleted(apiContext, product_Service_Images);
                    }
                    ...
                    foreach (Entities.Product_Service_Images product_Service_Images in product_Service_ImagesList)
                        OnDeleted(apiContext, product_Service_Images);
                }
    			catch (System.Data.OptimisticConcurrencyException ex)
                {
    				object forDebugging = ex;
    		...
    		/// <param name="product_Service_ImagesList"></param>
    		/// <returns></returns>
            public static Helpers.ActionResult Purge(Helpers.ApiContext apiContext, System.Collections.Generic.IEnumerable<Entities.Product_Service_Images> product_Service_ImagesList)
            {
    			// API doesn't allow null parameters. This method requires at least 1 item in the collection.
                if (apiContext == null)
                    throw new System.ArgumentNullException("apiContext");
                ...
                {				
                    ...
                    foreach (Entities.Product_Service_Images product_Service_Images in product_Service_ImagesList)
                    {
    					OnPurging(apiContext, product_Service_Images);
    					
    					// ATTACH object					
    					AttachObject(apiContext, "Product_Service_Images", product_Service_Images);
    					
    					// DELETE object
    					context.DeleteObject(product_Service_Images);
                    }
    
    				context.SaveChanges(); // Save Changes
    								
                    foreach (Entities.Product_Service_Images product_Service_Images in product_Service_ImagesList)
                        OnPurged(apiContext, product_Service_Images);
                }
    			catch (System.Data.OptimisticConcurrencyException ex)
                {
    				object forDebugging = ex;
    		...
    		/// <param name="product_Service_ImagesList"></param>
    		/// <returns></returns>
    		public static Helpers.ActionResult Get(Helpers.ApiContext apiContext, Helpers.QuerySettings<Entities.Product_Service_Images> querySettings, out System.Collections.Generic.List<Entities.Product_Service_Images> product_Service_ImagesList)
    		{
                // API doesn't allow null parameters.
                if (apiContext == null)
                    throw new System.ArgumentNullException("apiContext");
                ...
                try
                {
                    ...
                    System.Data.Objects.ObjectQuery<Entities.Product_Service_Images> query = context.Product_Service_Images;
    				...
    				product_Service_ImagesList = query
    		...
    		/// <returns></returns>
    		public static Helpers.ActionResult Count(Helpers.ApiContext apiContext, Helpers.QuerySettings<Entities.Product_Service_Images> querySettings, out int count)
    		{
                ...
                try
                {
                    ...
                    // execute the query with query settings applied
    				count = context.Product_Service_Images.Where(querySettings.GetWhereExpression()).Count();
                }
                catch (System.Exception ex)
                {      
    				object forDebugging = ex;
    		...
    		/// <param name="product_Service_ImagesList"></param>
            /// <returns></returns>
            public static Helpers.ActionResult BulkUpdate(Helpers.ApiContext apiContext, System.Collections.Generic.IEnumerable<Entities.Product_Service_Images> product_Service_ImagesList)
            {
                // API doesn't allow null parameters. This method requires at least 1 item in the collection.
                if (apiContext == null)
                    throw new System.ArgumentNullException("apiContext");
                ...
                try
                {
    				...
    				OnBulkUpdating(apiContext, product_Service_ImagesList);
    
    				foreach (Entities.Product_Service_Images product_Service_Images in product_Service_ImagesList)
                    {
    					OnUpdating(apiContext, product_Service_Images, true);					
    					...
    					// PARTIAL update					
                        OnPartialUpdate(apiContext, product_Service_Images);
                    }
                    ...
                    foreach (Entities.Product_Service_Images product_Service_Images in product_Service_ImagesList)
                        OnUpdated(apiContext, product_Service_Images, true);
    					
    				OnBulkUpdated(apiContext, product_Service_ImagesList);
                }
    			catch (System.Data.OptimisticConcurrencyException ex)
                {
    				object forDebugging = ex;
            ...
            /// <param name="product_Service_ImagesList"></param>
            /// <returns></returns>
            public static Helpers.ActionResult Import(Helpers.ApiContext apiContext, System.Collections.Generic.IEnumerable<Entities.Product_Service_Images> product_Service_ImagesList)
            {
                // API doesn't allow null parameters. This method requires at least 1 item in the collection.
                //if (apiContext == null)
                //    throw new System.ArgumentNullException("apiContext");
            ...
            /// <returns></returns>
            public static bool IsExists(Helpers.ApiContext apiContext, System.Linq.Expressions.Expression<System.Func<Entities.Product_Service_Images, bool>> whereClause)
            {
                // API doesn't allow null parameters. This method requires at least 1 item in the collection.
                if (apiContext == null)
                    throw new System.ArgumentNullException("apiContext");
                ...
                {
                    Model.OrmsContext context = (Model.OrmsContext)apiContext.CurrentContext;
                    return context.Product_Service_Images.Any(whereClause);
                }
                catch (System.Exception ex)
                {      
    				object forDebugging = ex;
    		...
    		/// <param name="id"></param>
            /// <returns></returns>
            public static bool IsExists(Helpers.ApiContext apiContext, System.Linq.Expressions.Expression<System.Func<Entities.Product_Service_Images, bool>> whereClause, long id)
            {
                // API doesn't allow null parameters. This method requires at least 1 item in the collection.
                if (apiContext == null)
                    throw new System.ArgumentNullException("apiContext");
                ...
                {
                    Model.OrmsContext context = (Model.OrmsContext)apiContext.CurrentContext;
                    id = context.Product_Service_Images.Where(whereClause).Select(e => e.Id).FirstOrDefault();                 
            ...
            /// <returns></returns>
           /* public static bool IsExists(Helpers.ApiContext apiContext, System.Linq.Expressions.Expression<System.Func<Entities.Product_Service_Images, bool>> whereClause, out System.Collections.Generic.List<int> iDs)
            {
                // API doesn't allow null parameters. This method requires at least 1 item in the collection.
                if (apiContext == null)
                    throw new System.ArgumentNullException("apiContext");
                ...
                {
                    Model.OrmsContext context = (Model.OrmsContext)apiContext.CurrentContext;
                    iDs = context.Product_Service_Images.Where(whereClause).Select(e => e.Id).ToList();
            ...
            /// <param name="iDs"></param>
            /// <returns></returns>
            public static bool IsExists(Helpers.ApiContext apiContext, System.Linq.Expressions.Expression<System.Func<Entities.Product_Service_Images, bool>> whereClause, System.Linq.Expressions.Expression<System.Func<Entities.Product_Service_Images, long>> selectClause, out System.Collections.Generic.List<long> iDs)
            {
                // API doesn't allow null parameters. This method requires at least 1 item in the collection.
                if (apiContext == null)
                    throw new System.ArgumentNullException("apiContext");
                ...
                {
                    Model.OrmsContext context = (Model.OrmsContext)apiContext.CurrentContext;
                    iDs = context.Product_Service_Images.Where(whereClause).Select(selectClause).ToList();
            ...
            /// <returns></returns>
            public static bool IsExists(Helpers.ApiContext apiContext, System.Linq.Expressions.Expression<System.Func<Entities.Product_Service_Images, bool>> whereClause, out System.Collections.Generic.List<Helpers.EntityKey> entityKeys)
            {
                // API doesn't allow null parameters. This method requires at least 1 item in the collection.
                if (apiContext == null)
                    throw new System.ArgumentNullException("apiContext");
                ...
                {
                   /* Model.OrmsContext context = (Model.OrmsContext)apiContext.CurrentContext;
                    entityKeys = context.Product_Service_Images
    									.Where(whereClause)
            ...
            /// <returns></returns>
            public static bool IsExists(Helpers.ApiContext apiContext, System.Linq.Expressions.Expression<System.Func<Entities.Product_Service_Images, bool>> whereClause, out Helpers.EntityKey entityKey)
            {
                // API doesn't allow null parameters. This method requires at least 1 item in the collection.
                if (apiContext == null)
                    throw new System.ArgumentNullException("apiContext");
    			...
    			/*
    				Model.OrmsContext context = (Model.OrmsContext)apiContext.CurrentContext;
                    var query = context.Product_Service_Images.Where(whereClause).Select(e => new { e.Id, e.ModifiedOn }).FirstOrDefault();
    					*/
    				entityKey = null;
    				/*
    				if (query != null)
            ...
            /// <returns></returns>
            public static bool IsExists(Helpers.ApiContext apiContext, System.Linq.Expressions.Expression<System.Func<Entities.Product_Service_Images, bool>> whereClause, out System.Collections.Generic.List<Entities.Product_Service_Images> entities)
            {
                // API doesn't allow null parameters. This method requires at least 1 item in the collection.
                if (apiContext == null)
                    throw new System.ArgumentNullException("apiContext");
                ...
                {
                    Model.OrmsContext context = (Model.OrmsContext)apiContext.CurrentContext;
                    var query = context.Product_Service_Images;
    				query.MergeOption = System.Data.Objects.MergeOption.NoTracking;
