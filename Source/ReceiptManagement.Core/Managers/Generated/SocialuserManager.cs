...
namespace ReceiptManagement.Core.Managers
{
    ...
    {	
    	#region Methods
    		...
    		public static Helpers.ActionResult Add(Helpers.ApiContext apiContext, Entities.SocialUser socialUser,out long id)
        	{
        		...
        		try
        		{
        			...
        			context.AddObject("Images", socialUser);
        				    
        			context.SaveChanges(); // Save Changes	
    			
                    id = socialUser.Id;
    
        			DetachObjects(apiContext, new System.Collections.Generic.List<Entities.SocialUser> {socialUser }); // Clean ObjectState cache
