...
namespace ReceiptManagement.Core.Managers
{
    ...
    {	
    	#region Methods
    		...
    		public static Helpers.ActionResult Add(Helpers.ApiContext apiContext, Entities.EventStatus eventStatus,out long id)
        	{
        		...
        		try
        		{
        			...
        			context.AddObject("Images", eventStatus);
        				    
        			context.SaveChanges(); // Save Changes	
    			
                    id = eventStatus.Id;
    
        			DetachObjects(apiContext, new System.Collections.Generic.List<Entities.EventStatus> {eventStatus }); // Clean ObjectState cache
