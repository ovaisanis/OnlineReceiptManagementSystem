...
namespace ReceiptManagement.Core.Managers
{
    ...
    {	
    	#region Methods
    		...
    		public static Helpers.ActionResult Add(Helpers.ApiContext apiContext, Entities.EventsInfo eventsInfo,out long id)
        	{
        		...
        		try
        		{
        			...
        			context.AddObject("Images", eventsInfo);
        				    
        			context.SaveChanges(); // Save Changes	
    			
                    id = eventsInfo.Id;
    
        			DetachObjects(apiContext, new System.Collections.Generic.List<Entities.EventsInfo> {eventsInfo }); // Clean ObjectState cache
