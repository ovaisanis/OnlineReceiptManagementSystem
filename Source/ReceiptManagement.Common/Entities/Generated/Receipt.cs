...
namespace ReceiptManagement.Common.Entities
{
    ...
    /// </summary>
    public partial class Receipt : Entities.EntityObject
    {
        ...
        static partial void OnCreated(Entities.Receipt receipt);
    	...
    	/// </summary>
    	/// <returns>The new Receipt instance. </returns>
    	public static Entities.Receipt Factory()
    	{
    		OnCreating();
        ...
        {
            if (previousValue != null && previousValue.Receipts.Contains(this))
            {
            ...
            if (User != null)
            {
                if (!User.Receipts.Contains(this))
                {
                    User.Receipts.Add(this);
                }
                if (UserId != User.Id)
                {
                    UserId = User.Id;
        ...
        private void FixupMy_Products_Services(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.Receipt, this))
                    {
                        item.Receipt = null;
                    }
                }
